...
These are documented in `reactome.py` but not wired in Phase 1:
...
| 3. Protein effect | UniProt | Accession, protein name, function text, domain features | Activity/stability/binding scores, loss-of-function score, structural impact placeholder |
...
Every value in cards 1–4 is tagged with one of four provenance categories:
